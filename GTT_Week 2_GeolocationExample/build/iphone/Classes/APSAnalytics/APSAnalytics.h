 ...
 * to send analytic data that can be viewed on the GTT_Week_2_GeolocationExample Dashboard.
 *
 * For information on getting started with GTT_Week_2_GeolocationExample Platform Services,
