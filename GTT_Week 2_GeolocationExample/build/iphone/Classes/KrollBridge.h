...
@interface GTT_Week_2_GeolocationExampleObject : KrollCoverageObject {
#else
@interface GTT_Week_2_GeolocationExampleObject : KrollObject {
#endif
@private
...
extern NSString * GTT_Week_2_GeolocationExample$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GTT_Week_2_GeolocationExampleObject *_gtt_week_2_geolocationexample;
    KrollObject* console;
	BOOL shutdown;
