...
//@interface GTT_Week_2_GeolocationExampleObject : NSObject
//@end

@interface GTT_Week_2_GeolocationExampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GTT_Week_2_GeolocationExampleObject class]])
		{
			for (NSString *key in [[(GTT_Week_2_GeolocationExampleObject*)o modules] allKeys])
			{
