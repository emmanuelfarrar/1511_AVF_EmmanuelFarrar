...
// in simulator we redefine to format for GTT_Week_2_GeolocationExample Developer console
...
{\
	NSString * exceptionName = [@"org.gtt_week_2_geolocationexample." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gtt_week_2_geolocationexample";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGTT_Week_2_GeolocationExampleNativeItemNone = -1, 
	UIGTT_Week_2_GeolocationExampleNativeItemSpinner = -2,
	UIGTT_Week_2_GeolocationExampleNativeItemProgressBar = -3,
	
	UIGTT_Week_2_GeolocationExampleNativeItemSlider = -4,
	UIGTT_Week_2_GeolocationExampleNativeItemSwitch = -5,
	UIGTT_Week_2_GeolocationExampleNativeItemMultiButton = -6,
	UIGTT_Week_2_GeolocationExampleNativeItemSegmented = -7,
	
	UIGTT_Week_2_GeolocationExampleNativeItemTextView = -8,
	UIGTT_Week_2_GeolocationExampleNativeItemTextField = -9,
	UIGTT_Week_2_GeolocationExampleNativeItemSearchBar = -10,
	
	UIGTT_Week_2_GeolocationExampleNativeItemPicker = -11,
	UIGTT_Week_2_GeolocationExampleNativeItemDatePicker = -12,
	
	UIGTT_Week_2_GeolocationExampleNativeItemInfoLight = -13,
	UIGTT_Week_2_GeolocationExampleNativeItemInfoDark = -14,
	
	UIGTT_Week_2_GeolocationExampleNativeItemDisclosure = -15,
	
	UIGTT_Week_2_GeolocationExampleNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all GTT_Week_2_GeolocationExample instances of
