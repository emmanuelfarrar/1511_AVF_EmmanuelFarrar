...
/**
 The base class for all GTT_Week_2_GeolocationExample modules
 */
...
/**
 GTT_Week_2_GeolocationExample Platform calls this method on startup.
 */
-(void)startup;

/**
 GTT_Week_2_GeolocationExample Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 GTT_Week_2_GeolocationExample Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 GTT_Week_2_GeolocationExample Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 GTT_Week_2_GeolocationExample Platform calls this method on resume.
 @param sender The sender of the event.
 */
