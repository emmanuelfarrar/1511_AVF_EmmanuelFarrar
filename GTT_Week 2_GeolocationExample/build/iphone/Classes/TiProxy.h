...
//Rare exceptions to indicate a bug in the _gtt_week_2_geolocationexample code (Eg, function that a subclass should have implemented)
...
/**
 The base class for GTT_Week_2_GeolocationExample proxies.
 */
