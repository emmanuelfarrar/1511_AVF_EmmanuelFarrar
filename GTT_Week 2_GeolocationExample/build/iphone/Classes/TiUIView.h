...
/**
 Base class for all GTT_Week_2_GeolocationExample views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GTT_Week_2_GeolocationExample view hierarchy (such as wrapped iOS UIViews) was touched.
