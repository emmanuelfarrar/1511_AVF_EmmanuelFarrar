...
//@interface Test_01Object : NSObject
//@end

@interface Test_01Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Test_01Object class]])
		{
			for (NSString *key in [[(Test_01Object*)o modules] allKeys])
			{
