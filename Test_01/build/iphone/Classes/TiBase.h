...
// in simulator we redefine to format for Test_01 Developer console
...
{\
	NSString * exceptionName = [@"org.test_01." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.test_01";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITest_01NativeItemNone = -1, 
	UITest_01NativeItemSpinner = -2,
	UITest_01NativeItemProgressBar = -3,
	
	UITest_01NativeItemSlider = -4,
	UITest_01NativeItemSwitch = -5,
	UITest_01NativeItemMultiButton = -6,
	UITest_01NativeItemSegmented = -7,
	
	UITest_01NativeItemTextView = -8,
	UITest_01NativeItemTextField = -9,
	UITest_01NativeItemSearchBar = -10,
	
	UITest_01NativeItemPicker = -11,
	UITest_01NativeItemDatePicker = -12,
	
	UITest_01NativeItemInfoLight = -13,
	UITest_01NativeItemInfoDark = -14,
	
	UITest_01NativeItemDisclosure = -15,
	
	UITest_01NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Test_01 instances of
