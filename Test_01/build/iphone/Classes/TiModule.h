...
/**
 The base class for all Test_01 modules
 */
...
/**
 Test_01 Platform calls this method on startup.
 */
-(void)startup;

/**
 Test_01 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Test_01 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Test_01 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Test_01 Platform calls this method on resume.
 @param sender The sender of the event.
 */
