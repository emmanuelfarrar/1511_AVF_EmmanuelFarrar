...
//Rare exceptions to indicate a bug in the _test_01 code (Eg, method that a subclass should have implemented)
...
+ (id)createProxy:(NSString*)qualifiedName withProperties:(NSDictionary*)properties inContext:(id<TiEvaluator>)context
{
	...
	if (proxyClass == nil) {
		NSString *_test_01 = [NSString stringWithFormat:@"%@%s",@"Ti","tanium."];
		if ([qualifiedName hasPrefix:_test_01]) {
		...
		if (proxyClass==nil) {
			...
			@throw [NSException exceptionWithName:@"org.test_01.module"
