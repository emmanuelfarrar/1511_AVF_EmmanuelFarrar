 ...
 * to send analytic data that can be viewed on the Week1_CommonJS_Example Dashboard.
 *
 * For information on getting started with Week1_CommonJS_Example Platform Services,
