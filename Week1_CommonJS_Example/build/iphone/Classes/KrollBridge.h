...
@interface Week1_CommonJS_ExampleObject : KrollCoverageObject {
#else
@interface Week1_CommonJS_ExampleObject : KrollObject {
#endif
@private
...
extern NSString * Week1_CommonJS_Example$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week1_CommonJS_ExampleObject *_week1_commonjs_example;
    KrollObject* console;
	BOOL shutdown;
