...
//@interface Week1_CommonJS_ExampleObject : NSObject
//@end

@interface Week1_CommonJS_ExampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week1_CommonJS_ExampleObject class]])
		{
			for (NSString *key in [[(Week1_CommonJS_ExampleObject*)o modules] allKeys])
			{
