...
// in simulator we redefine to format for Week1_CommonJS_Example Developer console
...
{\
	NSString * exceptionName = [@"org.week1_commonjs_example." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week1_commonjs_example";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek1_CommonJS_ExampleNativeItemNone = -1, 
	UIWeek1_CommonJS_ExampleNativeItemSpinner = -2,
	UIWeek1_CommonJS_ExampleNativeItemProgressBar = -3,
	
	UIWeek1_CommonJS_ExampleNativeItemSlider = -4,
	UIWeek1_CommonJS_ExampleNativeItemSwitch = -5,
	UIWeek1_CommonJS_ExampleNativeItemMultiButton = -6,
	UIWeek1_CommonJS_ExampleNativeItemSegmented = -7,
	
	UIWeek1_CommonJS_ExampleNativeItemTextView = -8,
	UIWeek1_CommonJS_ExampleNativeItemTextField = -9,
	UIWeek1_CommonJS_ExampleNativeItemSearchBar = -10,
	
	UIWeek1_CommonJS_ExampleNativeItemPicker = -11,
	UIWeek1_CommonJS_ExampleNativeItemDatePicker = -12,
	
	UIWeek1_CommonJS_ExampleNativeItemInfoLight = -13,
	UIWeek1_CommonJS_ExampleNativeItemInfoDark = -14,
	
	UIWeek1_CommonJS_ExampleNativeItemDisclosure = -15,
	
	UIWeek1_CommonJS_ExampleNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Week1_CommonJS_Example instances of
