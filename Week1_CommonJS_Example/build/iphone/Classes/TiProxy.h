...
//Rare exceptions to indicate a bug in the _week1_commonjs_example code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Week1_CommonJS_Example proxies.
 */
