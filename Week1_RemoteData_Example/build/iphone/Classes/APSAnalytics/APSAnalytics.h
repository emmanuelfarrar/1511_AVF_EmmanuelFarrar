 ...
 * to send analytic data that can be viewed on the Week1_RemoteData_Example Dashboard.
 *
 * For information on getting started with Week1_RemoteData_Example Platform Services,
