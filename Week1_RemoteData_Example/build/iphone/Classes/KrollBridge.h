...
@interface Week1_RemoteData_ExampleObject : KrollCoverageObject {
#else
@interface Week1_RemoteData_ExampleObject : KrollObject {
#endif
@private
...
extern NSString * Week1_RemoteData_Example$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week1_RemoteData_ExampleObject *_week1_remotedata_example;
    KrollObject* console;
	BOOL shutdown;
