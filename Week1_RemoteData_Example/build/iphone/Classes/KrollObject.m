...
//@interface Week1_RemoteData_ExampleObject : NSObject
//@end

@interface Week1_RemoteData_ExampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week1_RemoteData_ExampleObject class]])
		{
			for (NSString *key in [[(Week1_RemoteData_ExampleObject*)o modules] allKeys])
			{
