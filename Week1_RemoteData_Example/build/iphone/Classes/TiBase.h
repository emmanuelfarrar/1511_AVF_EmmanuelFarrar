...
// in simulator we redefine to format for Week1_RemoteData_Example Developer console
...
{\
	NSString * exceptionName = [@"org.week1_remotedata_example." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week1_remotedata_example";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek1_RemoteData_ExampleNativeItemNone = -1, 
	UIWeek1_RemoteData_ExampleNativeItemSpinner = -2,
	UIWeek1_RemoteData_ExampleNativeItemProgressBar = -3,
	
	UIWeek1_RemoteData_ExampleNativeItemSlider = -4,
	UIWeek1_RemoteData_ExampleNativeItemSwitch = -5,
	UIWeek1_RemoteData_ExampleNativeItemMultiButton = -6,
	UIWeek1_RemoteData_ExampleNativeItemSegmented = -7,
	
	UIWeek1_RemoteData_ExampleNativeItemTextView = -8,
	UIWeek1_RemoteData_ExampleNativeItemTextField = -9,
	UIWeek1_RemoteData_ExampleNativeItemSearchBar = -10,
	
	UIWeek1_RemoteData_ExampleNativeItemPicker = -11,
	UIWeek1_RemoteData_ExampleNativeItemDatePicker = -12,
	
	UIWeek1_RemoteData_ExampleNativeItemInfoLight = -13,
	UIWeek1_RemoteData_ExampleNativeItemInfoDark = -14,
	
	UIWeek1_RemoteData_ExampleNativeItemDisclosure = -15,
	
	UIWeek1_RemoteData_ExampleNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Week1_RemoteData_Example instances of
