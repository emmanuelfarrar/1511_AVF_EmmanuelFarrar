...
/**
 The base class for all Week1_RemoteData_Example modules
 */
...
/**
 Week1_RemoteData_Example Platform calls this method on startup.
 */
-(void)startup;

/**
 Week1_RemoteData_Example Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Week1_RemoteData_Example Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Week1_RemoteData_Example Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Week1_RemoteData_Example Platform calls this method on resume.
 @param sender The sender of the event.
 */
