...
/**
 Base class for all Week1_RemoteData_Example views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week1_RemoteData_Example view hierarchy (such as wrapped iOS UIViews) was touched.
