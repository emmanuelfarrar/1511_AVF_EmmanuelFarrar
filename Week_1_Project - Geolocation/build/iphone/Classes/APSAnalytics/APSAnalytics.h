 ...
 * to send analytic data that can be viewed on the Week_1_Project___Geolocation Dashboard.
 *
 * For information on getting started with Week_1_Project___Geolocation Platform Services,
