...
@interface Week_1_Project___GeolocationObject : KrollCoverageObject {
#else
@interface Week_1_Project___GeolocationObject : KrollObject {
#endif
@private
...
extern NSString * Week_1_Project___Geolocation$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week_1_Project___GeolocationObject *_week_1_project___geolocation;
    KrollObject* console;
	BOOL shutdown;
