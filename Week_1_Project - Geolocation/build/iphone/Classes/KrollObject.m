...
//@interface Week_1_Project___GeolocationObject : NSObject
//@end

@interface Week_1_Project___GeolocationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week_1_Project___GeolocationObject class]])
		{
			for (NSString *key in [[(Week_1_Project___GeolocationObject*)o modules] allKeys])
			{
