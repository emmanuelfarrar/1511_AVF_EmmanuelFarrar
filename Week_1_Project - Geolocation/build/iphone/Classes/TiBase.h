...
// in simulator we redefine to format for Week_1_Project___Geolocation Developer console
...
{\
	NSString * exceptionName = [@"org.week_1_project___geolocation." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week_1_project___geolocation";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek_1_Project___GeolocationNativeItemNone = -1, 
	UIWeek_1_Project___GeolocationNativeItemSpinner = -2,
	UIWeek_1_Project___GeolocationNativeItemProgressBar = -3,
	
	UIWeek_1_Project___GeolocationNativeItemSlider = -4,
	UIWeek_1_Project___GeolocationNativeItemSwitch = -5,
	UIWeek_1_Project___GeolocationNativeItemMultiButton = -6,
	UIWeek_1_Project___GeolocationNativeItemSegmented = -7,
	
	UIWeek_1_Project___GeolocationNativeItemTextView = -8,
	UIWeek_1_Project___GeolocationNativeItemTextField = -9,
	UIWeek_1_Project___GeolocationNativeItemSearchBar = -10,
	
	UIWeek_1_Project___GeolocationNativeItemPicker = -11,
	UIWeek_1_Project___GeolocationNativeItemDatePicker = -12,
	
	UIWeek_1_Project___GeolocationNativeItemInfoLight = -13,
	UIWeek_1_Project___GeolocationNativeItemInfoDark = -14,
	
	UIWeek_1_Project___GeolocationNativeItemDisclosure = -15,
	
	UIWeek_1_Project___GeolocationNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Week_1_Project___Geolocation instances of
