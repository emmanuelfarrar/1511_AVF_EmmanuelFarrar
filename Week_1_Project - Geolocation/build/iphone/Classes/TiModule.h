...
/**
 The base class for all Week_1_Project___Geolocation modules
 */
...
/**
 Week_1_Project___Geolocation Platform calls this method on startup.
 */
-(void)startup;

/**
 Week_1_Project___Geolocation Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Week_1_Project___Geolocation Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Week_1_Project___Geolocation Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Week_1_Project___Geolocation Platform calls this method on resume.
 @param sender The sender of the event.
 */
