...
//Rare exceptions to indicate a bug in the _week_1_project___geolocation code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Week_1_Project___Geolocation proxies.
 */
