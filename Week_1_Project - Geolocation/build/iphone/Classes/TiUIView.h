...
/**
 Base class for all Week_1_Project___Geolocation views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week_1_Project___Geolocation view hierarchy (such as wrapped iOS UIViews) was touched.
